...
namespace ResumeBuilderCapstone.Controllers
{
    ...
    public class CertificationController : ControllerBase
    {
        ...
        public CertificationController(CertificationService service) => _service = service;

        [HttpPost]
        public async Task<IActionResult> Create(Certification item) =>
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, Certification item)
        {
            if (id != item.CertificationId) return BadRequest("Id mismatch.");
