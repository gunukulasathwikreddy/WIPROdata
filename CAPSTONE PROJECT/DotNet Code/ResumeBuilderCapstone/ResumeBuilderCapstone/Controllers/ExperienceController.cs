...
namespace ResumeBuilderCapstone.Controllers
{
    ...
    public class ExperienceController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(Experience item) =>
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, Experience item)
        {
            if (id != item.ExperienceId) return BadRequest("Id mismatch.");
