...
-- Display all records whose name is 'Ashima'
...
select * from Emp where Empno IN(1,7,903)
GO

select * from Emp where Empno NOT IN(1,7,903)
GO
...
select * from Emp order by Dept DESC, Nam
GO
